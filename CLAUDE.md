...
## Run Information
- Mayhem Run: mayhemheroes/svf/saber/59
- Git Commit: 1a1999f5a4683d6bea74bcf18b1c53375d4787fe
- Original Image: ghcr.io/mayhemheroes/svf:master
- CI URL: https://github.com:443/mayhemheroes/SVF/actions/runs/3489667615
...
- `rlenv/source/svf/` - Source code (build from this location)
...
3. **Extract build steps**: Move build commands to `rlenv/mayhem/data/scripts/build.sh` that builds from `/rlenv/source/svf/`
...
- Source code should be at `/rlenv/source/svf/` in the container
- Build script should work from `/rlenv/source/svf/`
